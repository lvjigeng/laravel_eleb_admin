...
@section('content')
    <form class="form-group" method="post" action="{{route('shopCategory.update',['shopCategory'=>$shopCategory])}}" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <img src="{{$shopCategory->img}}" alt="" class="img-thumbnail" width="70px">
        </div>
